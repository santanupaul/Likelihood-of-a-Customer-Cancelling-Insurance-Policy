...
#                                             int1 = as.numeric(tenure)*as.numeric(creditlow),
#                                             int2 = as.numeric(claim.ind)*as.numeric(sales.channelPhone),
#                                             int3 = as.numeric(dwelling.typeCondo)*as.numeric(sales.channelPhone),
#                                             int4 = as.numeric(dwelling.typeTenant)*as.numeric(sales.channelPhone),
#                                             int5 = as.numeric(sales.channelPhone)*as.numeric(ni.age),
#                                             int6 = as.numeric(coverage.typeA)*as.numeric(dwelling.typeTenant),
#                                             int7 = as.numeric(coverage.typeC)*as.numeric(dwelling.typeTenant))

# all_vars <- c(all_vars, 'int1', 'int2', 'int3', 'int4', 'int5', 'int6', 'int7')
all_vars <- c(fact_vars, cont_vars_all)
...
train_val <- sample_n(all_fin, 0.8*nrow(all_fin))
test <- anti_join(all_fin,  train_val, by = "rnum")
...
fwrite(cstat_all, 'Elastic Net 0.5 AUCs_v2(Using Interactions).csv')